...
const translations = {
  en: {
    ...
    'storeProductsCount': '{count} Products',
    'storeShowingProducts': 'Showing {showing} of {total}',
    'storeShowingSearch': 'Showing {showing} of {total} for "{search}"',
    ...
    'storePageNext': 'Next',
    'storePageOf': 'Page {current} of {total}',
  ...
  sw: {
    ...
    'storeProductsCount': 'Bidhaa {count}',
    'storeShowingProducts': 'Inaonyesha {showing} kati ya {total}',
    'storeShowingSearch': 'Inaonyesha {showing} kati ya {total} kwa "{search}"',
    ...
    'storePageOf': 'Ukurasa {current} kati ya {total}',
